# hmpps-court-case-service-api

[![repo standards badge](https://img.shields.io/badge/endpoint.svg?&style=flat&logo=github&url=https%3A%2F%2Foperations-engineering-reports.cloud-platform.service.justice.gov.uk%2Fapi%2Fv1%2Fcompliant_public_repositories%2Fhmpps-court-case-service-api)](https://operations-engineering-reports.cloud-platform.service.justice.gov.uk/public-report/hmpps-court-case-service-api "Link to report")
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-court-case-service-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://hmpps-court-case-service-api-dev.hmpps.service.justice.gov.uk/webjars/swagger-ui/index.html?configUrl=/v3/api-docs)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-court-case-service-api/security/policy).
...
## Renaming from HMPPS Court Case Service Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-court-case-service-api=0
```
